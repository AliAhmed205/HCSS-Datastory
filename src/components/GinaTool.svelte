    ...
    const handleIntersection = (entries) => {
      entries.forEach((entry) => {
        ...
        if (entry.isIntersecting) {
          ...
          switch (svgId) {
            case "svg1":
              textEl.textContent = "The tool focuses on diplomatic engagement across the globe by analyzing and comparing voting and speech behavior on an international dyadic level.";
              break;
            case "svg2":
              textEl.textContent = "The data is analyzed using AI techniques such as Named Entity Recognition and Sentiment Analysis.";
              break;
            case "svg3":
              textEl.textContent = "The tool provides an interactive dashboard powered by advanced algorithms, enabling users to explore and visualize global diplomatic patterns with precision and ease.";
              break;
            case "svg4":
              textEl.textContent = "Aims to transcend the limitations of traditional analyses, shedding light on the complex tapestry of relational dynamics that constitute our world.";
              break;
            // Voeg hier meer cases toe voor andere SVG's
            default:
              textEl.textContent = "The tool focuses on diplomatic engagement across the globe by analyzing and comparing voting and speech behavior on an international dyadic level.";
              break;
          }
...
<section class="data-story">
  ...
  <svg id="svg1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
  ...
  <svg id="svg2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
  ...
  <svg id="svg3" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
  ...
  <svg id="svg4" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
