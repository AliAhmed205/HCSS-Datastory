...
<section class="data-story">
  <!-- Oekraïne Pie Charts -->
   <article>
    <div class="text-container">
      ...
      <p>In 2023, <span class="negative">negative</span> sentiments declined towards Ukraine. More countries adopted a <span class="neutral">neutral</span> tone in their speeches, while <span class="positive">positive</span> speeches saw a modest increase.
      </p>
    </div>
  ...
  <div class="text-container">
    ...
    <p>In 2023, sentiments toward Russia shifted notably, with <span class="positive">positive</span> speeches nearly doubling, <span class="neutral">neutral</span> speeches seeing a slight rise, and <span class="negative">negative</span> speeches declining.</p>
</div>
